/*
Title: Weather Station Transmittter Experiment 8
Programmer: Justin Lam
Date: 20/02/23
Description: Experiment to test RTC, payload acknowledgement and transmitting temperature, humidity, pressure, wind speed, VOC index, UV index and if it is raining.
*/
